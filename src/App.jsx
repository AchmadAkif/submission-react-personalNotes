    ...
    return (
      <div className='bg-[#18181B] text-white'>
        ...
        <div className='flex flex-col gap-y-32 px-48'>
          <Form handleNotesTitleInput={this.onNotesTitleInput} handleNotesContentInput={this.onNotesContentInput} notesTitleInput={this.state.notesTitleInput} notesContentInput={this.state.notesContentInput} inputLength={this.state.inputLength} />
