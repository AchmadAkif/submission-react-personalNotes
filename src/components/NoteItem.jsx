...
function NoteItem({ noteTitle, noteContent, noteDate }) {
  return (
    <div className='flex flex-col justify-between border-2'>
      ...
      <section className='flex justify-between border-t-2'>
        <Button name='Hapus' style='border-r-2 p-2 w-1/2 font-medium text-[#CE191F]' />
        <Button name='Arsipkan' style='w-1/2 font-medium text-[#F8FA93]' />
      </section>
    </div>
  );
}
