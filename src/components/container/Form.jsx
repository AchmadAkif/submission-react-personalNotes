...
function Form({ handleNotesTitleInput, handleNotesContentInput, handleFormSubmit, notesTitleInput, notesContentInput }) {
  return (
    <form
      onSubmit={handleFormSubmit}
      className='flex flex-col gap-y-2 md:px-32 lg:px-64'
    >
      <h1 className='my-6 font-medium text-[24px]'>Buat Catatan</h1>
      <span className='self-end'>Sisa karakter : {50 - notesTitleInput.length}</span>
      <TitleInput
